        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 28, marginTop: 32 }}>
          ...
          <FadeUp delay={0.2}>
            <div style={{
              ...
              <div style={{ fontFamily: 'var(--font-mono)', fontSize: 11, color: 'var(--text-muted)', letterSpacing: 2, marginBottom: 20 }}>
                PACKAGE B — 60名での試算
              </div>
              {[
                ...
                { label: '実効適用率', value: '40%（コーディング業務比率）', color: 'var(--text-secondary)' },
                { label: '月間追加開発能力', value: '¥48,000,000 相当', color: '#22c55e' },
                ...
                <div key={i} style={{
                  ...
                  <span style={{ fontFamily: 'var(--font-mono)', fontSize: 14, fontWeight: 600, color: row.color }}>
                    {row.value}
                  </span>
                </div>
              ))}
