...
const problems = [
  {
    icon: '👥',
    title: '開発人材の逼迫',
    desc: 'KDE単体 2,349名で桃鉄2、ゴエモン、eFootball、遊戯王等を同時並行開発。中途採用は常時募集中。',
  },
  {
    icon: '⚡',
    title: '新作の開発加速',
    desc: '2026年7月ゴエモン新作、ボンバーマンコレクション等の大型タイトルが控える。プロトタイプ速度が成否を分ける。',
  },
  {
    icon: '🏗️',
    title: '新拠点の稼働',
    desc: 'コナミクリエイティブフロント東京ベイ（有明）が2025年10月竣工。新たな開発プロセスの構築が急務。',
  },
  {
    icon: '🔄',
    title: '運用型ゲームの効率化',
    desc: 'eFootball等のライブオペレーション。日々の改善・A/Bテスト・ツール開発のサイクルを高速化したい。',
  },
];
    ...
    <SlideWrapper style={{ alignItems: 'flex-start', padding: '50px 70px' }}>
      <div style={{ width: '100%', maxWidth: 1200 }}>
        <FadeUp>
          ...
          <p style={{ color: 'var(--text-secondary)', fontSize: 15, marginTop: 8, maxWidth: 600, lineHeight: 1.6 }}>
